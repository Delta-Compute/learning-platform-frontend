...
export const AssignmentSummaryConversation: React.FC<AssignmentSummaryConversationProps> = ({
  ...
  useEffect(() => {
    ...
    // Set instructions
    client.updateSession({ instructions: instructionForSummaryAI(userName, assignmentSummary, classRoomProgress) });
  ...
  }, [assignmentSummary, classRoomProgress]);
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
      {loading && <Loader />}
      <div className="relative bg-white w-full h-full max-w-screen-md rounded-lg shadow-lg overflow-hidden">
        ...
        >
          <div className="pt-[100px] h-[calc(100dvh-142px)]">
            <div className="p-[20px] border-b-[1px] fixed z-[1] top-0 w-full bg-white">
              <div className="absolute top-[13%] right-[10px]">
                <button
            ...
            {!isConnected ? (
              <div className="px-[20px] pb-[200px] h-[calc(100dvh-170px)] w-full m-auto md:w-[700px]">
                  ...
                  <div className="h-full justify-center flex items-center">
                    <div>Start talking about students progress</div>
                  </div>
              </div>
            ) : (
