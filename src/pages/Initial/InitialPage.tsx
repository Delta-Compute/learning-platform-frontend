        ...
        <div className="flex flex-col gap-2 items-center justify-center w-full px-3">
          <Button
            ...
            className={`
              ...
              p-3 w-[100%] border-[1px] flex items-center justify-center gap-2
            `}
          >
            <svg fill="currentColor" className="w-[30px] h-[30px]" viewBox="0 0 24 24" role="img" xmlns="http://www.w3.org/2000/svg">
            ...
            <span>{t("authPages.initial.identifyButton")}</span>
          </Button>
