...
export const createClass = async (data: {name?: string, teacherId?: string, logo?: string, studentEmails?: string[], assignmentIds?: string[], learningPlan?: string}): Promise<Class> => {
  try {
